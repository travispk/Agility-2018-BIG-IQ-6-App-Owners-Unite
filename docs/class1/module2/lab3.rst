...
---------------------------
Connect as **paula** with password as **paula**. To create a new application, click on *Create*, and select the template previously created ``f5-HTTPS-WAF-lb-template-custom1``.
